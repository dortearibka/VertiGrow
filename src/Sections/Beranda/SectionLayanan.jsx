  ...
  return (
    <section className="flex justify-center my-28 px-6">
      <div className="w-full max-w-7xl">
        {/* Judul */}
        <p className="font-semibold text-center text-3xl md:text-4xl text-neutral-800 mb-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <Card className="shadow-lg rounded-xl transition duration-300 hover:scale-105">
            ...
            <Card.Body>
              ...
              <Card.Text className="text-sm text-neutral-600 mb-4">
              ...
              <button
                ...
                className="bg-[#387F39] text-white px-5 py-2 mt-12 rounded-full hover:bg-green-900 transition-all duration-300"
              >
